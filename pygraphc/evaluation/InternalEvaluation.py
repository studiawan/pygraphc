...
class InternalEvaluation(object):
    ...
    @staticmethod
    def get_silhoutte_index(clusters, mode, graph=None, cosine_similarity=None, h5file=''):
    ...
    @staticmethod
    def get_dunn_index(clusters, mode, graph=None, cosine_similarity=None, h5file=''):
